...
module AML
  class Client < ApplicationRecord
    ...
    belongs_to :current_order, class_name: 'AML::Order', dependent: :destroy, foreign_key: :order_id, optional: true

    after_create :create_current_order!

    # Нужно для для сериализера
    alias_attribute :current_order_id, :order_id
    ...
    def create_current_order! attrs = {}
      ...
      update_column :order_id, order.id
    end
  end
end
