module AML
  class Notification < ApplicationRecord
    ...
    has_one :payment_card_order_on_pending_notification, class_name: 'AML::PaymentCardOrder', foreign_key: :on_pending_notification_id, dependent: :nullify
    has_one :payment_card_order_on_accept_notification, class_name: 'AML::PaymentCardOrder', foreign_key: :on_accept_notification_id, dependent: :nullify
    has_one :payment_card_order_on_reject_notification, class_name: 'AML::PaymentCardOrder', foreign_key: :on_reject_notification_id, dependent: :nullify
